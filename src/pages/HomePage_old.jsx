...
import { Target, Eye, Award, Cpu, ChevronRight, Calendar, MapPin, Mail, Phone, Instagram, Linkedin, Github, Users, ExternalLink, Zap, Trophy, Rocket } from 'lucide-react'
  ...
  return (
    <div className="relative">
      ...
      <div className="h-screen bg-black text-white overflow-hidden relative">
        ...
        {/* Neon overlay */}
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-cyan-950/20 to-black/80 z-5"></div>

        {/* Content Boxes positioned around the drone */}
        {contentBoxes.map((box) => (
          <div key={box.id} className={`${getPositionClasses(box.position)} z-10 slide-in-up`}>
            <div className="h-50 bg-black/60 backdrop-blur-xl rounded-3xl p-6 mt-10 border-2 neon-glow shadow-2xl transition-all duration-300 group cursor-pointer hover:scale-105 hover:bg-black/70"
                 style={{
                   borderColor: '#00ffff',
                   boxShadow: '0 0 20px rgba(0, 255, 255, 0.5), inset 0 0 20px rgba(0, 255, 255, 0.1)'
                 }}>
              <div className="flex items-center mb-4">
                <div className="w-14 h-14 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-xl flex items-center justify-center mr-4 border-2 border-cyan-400 transition-all backdrop-blur-sm group-hover:scale-110 neon-glow"
                     style={{
                       boxShadow: '0 0 20px rgba(0, 255, 255, 0.8)'
                     }}>
                  <box.icon className="w-7 h-7 text-white" />
                </div>
                <h3 className="text-2xl font-bold text-cyan-300 group-hover:text-cyan-200 transition-colors neon-text-anim"
                    style={{
                      textShadow: '0 0 10px #00ffff, 0 0 20px #00ffff'
                    }}>{box.title}</h3>
              </div>
              <p className="text-gray-100 leading-relaxed text-lg group-hover:text-white transition-colors">
                {box.content}
              </p>
            </div>
          </div>
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-10 text-center">
          <div className="bg-black/70 backdrop-blur-xl shadow-2xl rounded-3xl px-10 py-5 border-2 border-cyan-400 transition-all duration-300 group cursor-pointer hover:scale-110 neon-glow glitch-effect"
               style={{
                 boxShadow: '0 0 30px rgba(0, 255, 255, 0.6), inset 0 0 20px rgba(0, 255, 255, 0.2)'
               }}>
            <p className="text-gray-100 text-xl">
              <span className="text-cyan-300 font-bold text-3xl neon-text-anim" style={{
                textShadow: '0 0 20px #00ffff, 0 0 30px #00ffff, 0 0 40px #00ffff'
              }}>DRC</span>
              <span className="text-pink-400 mx-2">•</span>
              <span className="text-gray-300">Drone & Robotics Club</span>
            </p>
          </div>
        </div>
      </div>
      ...
      <section className="bg-black text-white py-20 border-t border-cyan-500/30">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center p-8 bg-black/60 backdrop-blur-md rounded-3xl border-2 border-cyan-500 transition-all hover:scale-110 hover:border-cyan-300 group slide-in-up neon-glow"
                 style={{
                   boxShadow: '0 0 20px rgba(0, 255, 255, 0.5)'
                 }}>
              <Trophy className="w-14 h-14 mx-auto mb-4 text-cyan-400 group-hover:text-cyan-300 transition-colors"
                      style={{ filter: 'drop-shadow(0 0 10px #00ffff)' }} />
              <div className="text-5xl font-bold text-cyan-300 mb-2 neon-text-anim" style={{
                textShadow: '0 0 20px #00ffff'
              }}>15+</div>
              <div className="text-gray-300 text-lg">Awards Won</div>
            </div>
            <div className="text-center p-8 bg-black/60 backdrop-blur-md rounded-3xl border-2 border-pink-500 transition-all hover:scale-110 hover:border-pink-300 group slide-in-up"
                 style={{
                   boxShadow: '0 0 20px rgba(255, 0, 255, 0.5)',
                   animationDelay: '0.1s'
                 }}>
              <Users className="w-14 h-14 mx-auto mb-4 text-pink-400 group-hover:text-pink-300 transition-colors"
                     style={{ filter: 'drop-shadow(0 0 10px #ff00ff)' }} />
              <div className="text-5xl font-bold text-pink-300 mb-2" style={{
                textShadow: '0 0 20px #ff00ff'
              }}>100+</div>
              <div className="text-gray-300 text-lg">Active Members</div>
            </div>
            <div className="text-center p-8 bg-black/60 backdrop-blur-md rounded-3xl border-2 border-yellow-500 transition-all hover:scale-110 hover:border-yellow-300 group slide-in-up"
                 style={{
                   boxShadow: '0 0 20px rgba(255, 255, 0, 0.5)',
                   animationDelay: '0.2s'
                 }}>
              <Rocket className="w-14 h-14 mx-auto mb-4 text-yellow-400 group-hover:text-yellow-300 transition-colors"
                      style={{ filter: 'drop-shadow(0 0 10px #ffff00)' }} />
              <div className="text-5xl font-bold text-yellow-300 mb-2" style={{
                textShadow: '0 0 20px #ffff00'
              }}>30+</div>
              <div className="text-gray-300 text-lg">Projects</div>
            </div>
            <div className="text-center p-8 bg-black/60 backdrop-blur-md rounded-3xl border-2 border-green-500 transition-all hover:scale-110 hover:border-green-300 group slide-in-up"
                 style={{
                   boxShadow: '0 0 20px rgba(0, 255, 0, 0.5)',
                   animationDelay: '0.3s'
                 }}>
              <Zap className="w-14 h-14 mx-auto mb-4 text-green-400 group-hover:text-green-300 transition-colors"
                   style={{ filter: 'drop-shadow(0 0 10px #00ff00)' }} />
              <div className="text-5xl font-bold text-green-300 mb-2" style={{
                textShadow: '0 0 20px #00ff00'
              }}>50+</div>
              <div className="text-gray-300 text-lg">Events</div>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* About Us Section */}
      <section className="bg-gradient-to-b from-black via-gray-900 to-black text-white py-20 border-t border-blue-500/10">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-400 to-blue-400 mb-8">About Us</h2>
            <div className="space-y-6 text-lg text-gray-300 leading-relaxed">
              <p className="backdrop-blur-sm bg-gradient-to-r from-blue-900/10 to-purple-900/10 p-6 rounded-2xl border border-blue-500/20">
              ...
              <p className="backdrop-blur-sm bg-gradient-to-r from-purple-900/10 to-blue-900/10 p-6 rounded-2xl border border-purple-500/20">
      ...
      <section className="bg-gradient-to-b from-black via-gray-900 to-black text-white py-20 border-t border-blue-500/10">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-400 to-blue-400 mb-4">Recent and Upcoming Events</h2>
          </div>
